...
package com.webBase.JSconnect {
    ...
    public class SWFAddress {
		 ...
		 * @param	
		 * @author  wolf
		 * @serialData 2009-12-30 15:06
		 */
		public static function setWidth(param:Number):void {
           ExternalInterface.call("setWidth",param);  
        }
		/**
		 * SWF߶
		 * @param	߶
		 ...
		 * @serialData 2009-12-30 15:06
		 */
		public static function setHeight(param:Number):void {
           ExternalInterface.call("setHeight", param);  
        }
		/**
		 * ղؼ
		 * @param	sURL
		 * @param	sTitle
		 */
		public static function AddFavorite(sURL:String, sTitle:String):void
		{
			ExternalInterface.call("AddFavorite", sURL,sTitle,""+sURL+"ղʧܣʹCtrl+Dӣ");  
		}
		/**
		 * رմ
		 */
