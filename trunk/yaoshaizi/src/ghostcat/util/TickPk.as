package ghostcat.util
{
	 ...
	 * 
	 */	
	public class TickPk extends EventDispatcher
	{
		static private var _instance:TickPk;
		static public function get instance():TickPk
		{
			if (!_instance)
				_instance = new TickPk();
